// TODO: share this scaffolding across repos (git submodules?)
// so repos themselves are only code-solver code and inputs


// pasted right from `adventofcode-2022`
// TODO: update stdlib
import {
    dirname,
    fromFileUrl,
